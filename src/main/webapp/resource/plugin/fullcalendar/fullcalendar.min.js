...
(function (t, e) {
                ...
                t.each(this.split(","), function (e, i) {
                    if ("title" == i) a.append("<span class='fc-header-title'><h2>&nbsp;</h2></span>"), o && o.addClass(v + "-corner-right"), o = null; else {
                        ...
                        if (n[i] ? s = n[i] : me[i] && (s = function () {
                            ...
                            var l = r.theme ? q(r.buttonIcons, i) : null, c = q(r.buttonText, i),
    ...
    function o(n, r) {
        ...
        function s(r, a) {
            ...
            if (c) t.isFunction(c) ? (m(), c(d(E), d(T), function (t) {
                ...
                if (u) {
                    ...
                    var p = t.extend({}, f || {}), b = X(r.startParam, n.startParam), D = X(r.endParam, n.endParam);
        ...
        function c(n) {
            return t.isFunction(n) || t.isArray(n) ? n = {events: n} : "string" == typeof n && (n = {url: n}), "object" == typeof n ? (D(n), F.push(n), n) : e
        }
        ...
        for (var E, T, S = M.trigger, x = M.getView, k = M.reportEvents, H = {events: []}, F = [H], R = 0, N = 0, z = 0, W = [], A = 0; r.length > A; A++) c(r[A])
    }
    ...
    function c(t, e) {
        if (+t) for (; t.getDate() != e.getDate();) t.setTime(+t + (e > t ? 1 : -1) * Ce)
    }
    ...
    function D(t, e, n, r) {
        ...
        for (a = 0; u > a; a++) if (o = n.charAt(a), "'" == o) {
            ...
            for (i = a + 1; u > i; i++) if ("]" == n.charAt(i)) {
                var v = n.substring(a + 1, i), d = b(l, v, r);
                d != b(c, v, r) && (f += d), a = i;
                break
            }
        } else if ("{" == o) l = e, c = t; else if ("}" == o) l = t, c = e; else {
            for (i = u; i > a; i--) if (s = Ee[n.substring(a, i)]) {
                l && (f += s(l, r)), a = i - 1;
                break
            }
            i == a && l && (f += o)
    ...
    function Z(e, n, r) {
        ...
        function v() {
            var t, e, n, r = he + "-widget-content", a = "";
        ...
        function h(t) {
            var e = he + "-widget-content", n = O.start.getMonth(), r = f(new Date), a = "",
        ...
        var L, _, q, j, I, X, J, V, U, Z, $, Q, K, te, ee, ne, re, oe, ie, se, de, he, ge, pe, me, ye, be = O.opt,
            we = O.trigger, Ce = O.renderOverlay, Me = O.clearOverlays, Ee = O.daySelectionMousedown, Te = O.cellToDate,
            Se = O.dateToCell, xe = O.rangeToSegments, ke = n.formatDate;
    ...
    function K(n, r, a) {
        ...
        function s() {
            var e, r, a, o, i, s = Be + "-widget-header", l = Be + "-widget-content", f = 0 == Ze("slotMinutes") % 15;
        ...
        function g() {
            var t, e, n, r = Be + "-widget-header", a = "";
        ...
        function p() {
            var t, e, n, r, a, o = Be + "-widget-header", i = Be + "-widget-content", s = f(new Date), l = "";
        ...
        function m(t) {
            t === e && (t = xe), xe = t, ln = {};
            var n = re.position().top, r = be.position().top, a = Math.min(t - n, Me.height() + r + 1);
        ...
        function E(t) {
            if (!Ze("selectable")) {
                var e = Math.min(Ae - 1, Math.floor((t.pageX - K.offset().left - ke) / He)), n = rn(0, e),
                    r = this.parentNode.className.match(/fc-slot(\d+)/);
                if (r) {
                    var a = parseInt(r[1]) * Ze("slotMinutes"), o = Math.floor(a / 60);
        ...
        function H(t, e) {
            for (var n = 0; Ae > n; n++) {
                var r = rn(0, n), a = l(d(r), 1), o = new Date(Math.max(r, t)), i = new Date(Math.min(a, e));
                if (i > o) {
                    var s = Le.rect(0, n, 0, n, we), c = _(r, o), u = _(r, i);
        ...
        function _(t, n) {
            ...
            var r = Ze("slotMinutes"), a = 60 * n.getHours() + n.getMinutes() - je, o = Math.floor(a / r), i = ln[o];
        ...
        function J(e, n) {
            ...
            if (Le.build(), r) {
                var a = an(e).col;
                if (a >= 0 && Ae > a) {
                    var o = Le.rect(0, a, 0, a, we), i = _(e, e), s = _(e, n);
                    if (s > i) {
        ...
        function G(t, e) {
            _e.start(function (t) {
                if (Qe(), t) if (A(t)) k(t.row, t.col, t.row, t.col); else {
                    var e = L(t), n = u(d(e), Ze("defaultEventMinutes"));
                    H(e, n)
                }
            }, e)
        }
        ...
        var K, ee, ne, re, oe, ie, se, de, he, ge, pe, me, ye, be, we, Ce, Me, Ee, Te, Se, xe, ke, He, Fe, Re, Ne, ze,
            We, Ae, Oe, Le, _e, qe, Ye, Be, Pe, je, Ie, Xe, Je, Ve, Ue, Ze = Q.opt, Ge = Q.trigger,
            $e = Q.renderOverlay, Qe = Q.clearOverlays, Ke = Q.reportSelection, tn = Q.unselect,
            en = Q.daySelectionMousedown, nn = Q.slotSegHtml, rn = Q.cellToDate, an = Q.dateToCell,
            on = Q.rangeToSegments, sn = r.formatDate, ln = {};
    ...
    function te() {
        ...
        function a(e) {
            var n, r, a, s, l, c, f, v = P(), h = W(), g = z(), p = t.map(e, i), m = [];
            for (r = 0; v > r; r++) for (n = q(0, r), u(n, h), a = ee(o(e, p, n, u(d(n), g - h))), ne(a), s = 0; a.length > s; s++) for (l = a[s], c = 0; l.length > c; c++) f = l[c], f.col = r, f.level = s, m.push(f);
            return m
        }
        ...
        function s(n, r) {
            var a, o, i, s, l, u, d, v, h, g, p, m, D, w, C, M, T, S, k, H = n.length, N = "", z = F();
        ...
        function v(t, e, n) {
            ...
            var a, o, i, s = n.isStart, c = !0, u = N(), f = I(), v = X(), g = J(), p = W();
            e.draggable({
                opacity: y("dragOpacity", "month"), revertDuration: y("dragRevertDuration"), start: function (n, p) {
                    ...
                    if (u.stop(), te(), b("eventDragStop", e, t, n, a), o) r(), e.css("filter", ""), Z(t, e); else {
                        var s = 0;
        ...
        function g(t, e, n) {
            ...
            var o, i, s, c, f, v, g, p, D, w, M, E = m.getCoordinateGrid(), T = P(), S = I(), x = X(), k = J();
            e.draggable({
                scroll: !1,
                grid: [S, x],
                axis: 1 == T ? "y" : !1,
        ...
        var y = m.opt, b = m.trigger, D = m.isEventDraggable, w = m.isEventResizable, M = m.eventEnd,
            T = m.eventElementHandlers, k = m.setHeight, H = m.getDaySegmentContainer, F = m.getSlotSegmentContainer,
            N = m.getHoverListener, z = m.getMaxMinute, W = m.getMinMinute, A = m.timePosition, O = m.getIsCellAllDay,
            L = m.colContentLeft, _ = m.colContentRight, q = m.cellToDate, B = m.segmentCompare, P = m.getColCnt,
            I = m.getColWidth, X = m.getSnapHeight, J = m.getSnapMinutes, V = m.getSlotContainer,
            U = m.reportEventElement, Z = m.showEvents, G = m.hideEvents, $ = m.eventDrop, Q = m.eventResize,
            K = m.renderDayOverlay, te = m.clearOverlays, re = m.renderDayEvents, ae = m.calendar, ie = ae.formatDate,
            se = ae.formatDates;
    ...
    function ee(t) {
        ...
        for (e = 0; s > e; e++) {
            for (n = t[e], r = 0; ;) {
                if (a = !1, i[r]) for (o = 0; i[r].length > o; o++) if (re(i[r][o], n)) {
                    a = !0;
                    break
                }
                if (!a) break;
    ...
    function ne(t) {
        var e, n, r, a, o, i;
        for (e = t.length - 1; e > 0; e--) for (a = t[e], n = 0; a.length > n; n++) for (o = a[n], r = 0; t[e - 1].length > r; r++) i = t[e - 1][r], re(o, i) && (i.forward = Math.max(i.forward || 0, (o.forward || 0) + 1))
    }
    ...
    function ae(n, r, a) {
        ...
        function p(t, e) {
            U.push({event: t, element: e}), V[t._id] ? V[t._id].push(e) : V[t._id] = [e]
        }
        ...
        function F(t, e) {
            var n = B.getColCnt(), r = ee ? -1 : 1, a = ee ? n - 1 : 0;
        ...
        function O(t) {
            var e = B.getColCnt(), n = ee ? -1 : 1, r = ee ? e - 1 : 0, a = Math.floor(t / e),
                o = (t % e + e) % e * n + r;
            return {row: a, col: o}
        }
        ...
        var P = B.defaultEventEnd, j = r.normalizeEvent, I = r.reportEventChange, J = {}, V = {}, U = [], Z = r.options;
        ...
        var G, $ = o("hiddenDays") || [], Q = [], K = [], te = [], ee = o("isRTL");
        (function () {
    ...
    function oe() {
        ...
        function c(t) {
            var e = "", n = S("isRTL"), r = t.event, a = r.url, o = ["fc-event", "fc-event-hori"];
        ...
        function M(e, r, a) {
            var o = S("isRTL"), i = o ? "w" : "e", s = r.find(".ui-resizable-" + i), c = !1;
            B(r), r.mousedown(function (t) {
                ...
                if (1 == o.which) {
                    ...
                    var u = te();
                    q(), P();
                    var f, d, v = r.css("top"), h = t.extend({}, e), g = ce(le(e.start));
        ...
        var S = T.opt, k = T.trigger, H = T.isEventDraggable, F = T.isEventResizable, R = T.eventEnd,
            N = T.reportEventElement, z = T.eventElementHandlers, W = T.showEvents, A = T.hideEvents, O = T.eventDrop,
            _ = T.eventResize, q = T.getRowCnt, P = T.getColCnt;
        T.getColWidth;
        var I = T.allDayRow, X = T.colLeft, J = T.colRight, V = T.colContentLeft, U = T.colContentRight;
        T.dateToCell;
        var Z = T.getDaySegmentContainer, G = T.calendar.formatDates, $ = T.renderDayOverlay, Q = T.clearOverlays,
            K = T.clearSelection, te = T.getHoverListener, ee = T.rangeToSegments, ne = T.segmentCompare,
            re = T.cellToDate, ae = T.cellToCellOffset, oe = T.cellOffsetToDayOffset, le = T.dateToDayOffset,
    ...
    }, pe = t.fullCalendar = {version: "1.6.3"}, me = pe.views = {};
    ...
    pe.dateFormatters = Ee, pe.applyAll = I, me.month = J, me.basicWeek = V, me.basicDay = U, n({weekMode: "fixed"}), me.agendaWeek = $, me.agendaDay = Q, n({
        allDaySlot: !0,
        allDayText: "all-day",
        firstHour: 6,
        slotMinutes: 30,
